...
//import Combine
//
//class Bloc<Event:Equatable, State:Equatable> {
//
//    @Published private(set) var state: State
//
//    var transition: AnyPublisher<Transition<Event, State>, Never> { transitionSubject.eraseToAnyPublisher() }
...
//
//    final func send(_ value: Event) { eventSubject.send(value) }
//
