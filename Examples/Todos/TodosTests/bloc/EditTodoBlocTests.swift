...
class EditTodoBlocTests: XCTestCase {
  ...
  func testNameChanged() {
    ...
    [
      ...
      .NameChanged("T"),
      .NameChanged("")
    ].publisher.subscribe(editTodoBloc.subscriber)
    ...
    let validNameState = EditTodoState.ValidTodo(ValidTodoState(
      name: "T",
      isDone: todo
        .isDone,
      description: "",
  ...
  func testDoneChanged() {
    ...
    let toggleDoneState = EditTodoState
      .ValidTodo(ValidTodoState(
        name: "Todo",
        isDone: true,
        description: "",
