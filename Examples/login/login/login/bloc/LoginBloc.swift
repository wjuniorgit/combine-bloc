...
extension LoginState {
  ...
  func copyWith(
    userName: String? = nil,
    password: String? = nil,
    loginFormState: LoginFormState? = nil
  ) -> LoginState {
...
final class LoginBloc: Bloc<LoginEvent, LoginState> {
  init(
    ...
    onLoginRequested: @escaping (_ username: String, _ password: String)
      -> Void
  ) {
    func loginStateFromAuthenticationState(
    ...
    let initialLoginState =
      loginStateFromAuthenticationState(authenticationState)
